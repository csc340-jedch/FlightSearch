...
public class Encryption {
    ...
    public static String getEncryptedPassword(String _password, String _salt) throws NoSuchAlgorithmException {
        // MD5 hash the salt
    ...
    private static String md5(String _input) throws NoSuchAlgorithmException {
